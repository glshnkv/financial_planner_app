...
class AddIncomePanel extends StatefulWidget {
  final PanelController controller;

  const AddIncomePanel({super.key, required this.controller});

  @override
  State<AddIncomePanel> createState() => _AddIncomePanelState();
}

class _AddIncomePanelState extends State<AddIncomePanel> {

...
const String _ktotalAmountKey = 'totalAmount';
...
class SharedPreferencesService {
  ...
  double get totalAmount => _getData(_ktotalAmountKey) ?? 0;
  set totalAmount(double value) => _saveData(_ktotalAmountKey, value);
